...
Route::get('/cars/{car}', 'App\Http\Controllers\CarController@show');
Route::post('/cars', 'App\Http\Controllers\CarController@store');
Route::put('/cars/{car}', 'App\Http\Controllers\CarController@update');
Route::delete('/cars/{auto}', 'App\Http\Controllers\CarController@destroy');
